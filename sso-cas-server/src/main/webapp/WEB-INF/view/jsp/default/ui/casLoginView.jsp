...
<div class="box" id="login">
  <form:form method="post" id="fm1" commandName="${commandName}" htmlEscape="true">
    ...
    <section class="row">
      ...
      <form:input tabindex="3" path="captcha" placeholder="" htmlEscape="true" maxlength="4" size="15"/>
      <img style="cursor:pointer; vertical-align:middle; width:60px; height:25px;" src="captcha.jpg" onClick="this.src='captcha.jpg?time'+Math.random();">
    </section>
