...
<div class="box" id="login">
    <form:form method="post" id="fm1" commandName="${commandName}" htmlEscape="true">
        ...
        <section class="row">
            ...
            <form:input cssClass="required" cssErrorClass="error" id="verifyCode" size="25" tabindex="2" path="verifyCode" htmlEscape="true" autocomplete="off" placeholder="输入验证码" />
            <img src="/kaptcha.jpg" onclick="this.src='/kaptcha.jpg'"/>
        </section>
